...
/*
 * Skapat en ny atom som är just till för -
 * produkterna i den produktsida som jag ska skapa.
 * Importerat id: från Oscars gist-fil. Varje " "id":x" har ett unikt värde.
 *
